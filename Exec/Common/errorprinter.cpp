...
ErrorPrinter::ErrorPrinter()
{
    ...
    errorMap.insert(StatusMap::value_type(HASP_IDENTITY_EXPIRED, "The identity is expired"));
    errorMap.insert(StatusMap::value_type(HASP_INV_OPTION, "Invalid option value"));
    errorMap.insert(StatusMap::value_type(HASP_CLOUD_STORAGE_BUSY, "Busy error with the license storage"));
    errorMap.insert(StatusMap::value_type(HASP_MACHINE_DENIED, "This machine cannot be used"));
    errorMap.insert(StatusMap::value_type(HASP_MACHINE_DISABLED, "This machine is disabled"));
    errorMap.insert(StatusMap::value_type(HASP_IDENTITY_RATE_LIMIT_EXCEEDED, "The rate at which identity requests are received exceeds the contracted limit"));
    errorMap.insert(StatusMap::value_type(HASP_FEATURE_START_DATE_NOT_REACHED, "Feature start date not yet reached"));
